...
def test_lookup_arkansas():
  kmvi = KsMyVoteInfo(state='ar', url='https://www.voterview.ar-nova.org/voterview')
  r = kmvi.lookup(first_name='William', last_name='Hutchinson', dob='1950-12-03')
  pprint(r.parsed())
  assert r.parsed()[0]['tree']['Political Party'] == 'Republican'

def test_lookup_rockthevote():
  kmvi = KsMyVoteInfo(state='rockthevote', url='https://am-i-registered-to-vote.org/verify-registration.php')
